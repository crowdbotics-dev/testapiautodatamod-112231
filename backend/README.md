...
## Project Structure
    ...
    ├── testapiautodatamod_112231  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_112231`
...
2. Clone this repo and `cd testapiautodatamod_112231`
